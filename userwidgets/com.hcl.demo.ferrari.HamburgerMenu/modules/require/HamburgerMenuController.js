define(function() {
  ...
  return {
    ...
    toggle(open, skipAnimation){
      skipAnimation = (voltmx.os.deviceInfo().name === voltmx.sdk.constants.PLATFORM_THIN_CLIENT || voltmx.os.deviceInfo().name === voltmx.sdk.constants.PLATFORM_SPA) ? true : skipAnimation;
      if(skipAnimation){
